...
public class FrmLocation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "AZUAY", "BOLIVAR", "CAÑAR", "CARCHI", "COTOPAXI", "PICHINCHA" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "QUITO", "CUENCA", "GUARANDA", "AZOGUEZ", "TULCAN", "SIGCHOS", " " }));

        jButton1.setText("SUBIT");
